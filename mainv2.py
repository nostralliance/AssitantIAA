...
def query_openai_with_context(knowledge_base_text, conversation_history, user_input, supplemental_text=""):
    openai.api_key = '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'
    try:
        messages = [
