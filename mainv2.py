...
def query_openai_with_context(knowledge_base_text, conversation_history, user_input, supplemental_text=""):
    openai.api_key = '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'
    try:
        messages = [
