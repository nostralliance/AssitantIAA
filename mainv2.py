...
def query_openai_with_context(knowledge_base_text, conversation_history, user_input, supplemental_text=""):
    openai.api_key = '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'
    try:
        messages = [
